        ...
        <section class="login-register container">
            <ul class="nav nav-tabs mb-5" id="login_register" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link nav-link_underscore active" id="register-tab" data-bs-toggle="tab" href=""
                ...
                <div class="tab-pane fade show active" id="tab-item-register" role="tabpanel"
                    ...
                    <div class="register-form">
                        <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation"
                            ...
                            <div class="form-floating mb-3">
                              <input class="form-control form-control_gray @error('mobile') is-invalid @enderror"
